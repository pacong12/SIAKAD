...
class DropPenilaiangurusTable extends Migration
{
    /**
     * Run the migrations.
     * 
     * Note: Tabel penilaiangurus sudah dihapus secara manual menggunakan Schema::dropIfExists()
     *
     * @return void
     */
    public function up()
    {
        // Tabel sudah dihapus secara manual melalui tinker
